<?php
	...
	{	
		...
		{
			global $conn;
			$pName = addslashes($_POST["propertyName"]);
			$pType = addslashes($_POST["propertyType"]);
			$oName = addslashes($_POST["ownerName"]);
			$oNumber = addslashes($_POST["ownerPnumber"]);
			$pPrice = addslashes($_POST["propertyPrice"]);
			$pAddress = addslashes($_POST["propertyAddress"]);
			$pSize = addslashes($_POST["propertySize"]);
			$pRooms = addslashes($_POST["rooms"]);
			$pBedrooms = addslashes($_POST["bedrooms"]);
			$pBathrooms = addslashes($_POST["bathrooms"]);
			$pBalconys = addslashes($_POST["balconys"]);
			$pAge = addslashes($_POST["propertyAge"]);
			...
			$pDescription = addslashes($_POST["propertyDescription"]);
